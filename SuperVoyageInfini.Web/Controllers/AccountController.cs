...
using SuperVoyageInfini.Web.Models;
using System.Linq;
...
namespace SuperVoyageInfini.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //Aller chercher l'utilisateur avec son email
            ApplicationUser signedUser = UserManager.FindByEmail(model.Email);

            //Si on ne trouve pas l'email, on va chercher l'utilisateur avec son UserName
            if (signedUser == null)
            {
                signedUser = UserManager.FindByName(model.Email);
                //Si on ne trouve pas le UserName, on envoie un message d'erreur
                if (signedUser == null)
                {
